...
import com.employee.service.persistence.impl.constants.TDTPersistenceConstants;
...
public class EmployeePersistenceImpl
	...
	@Override
	@Reference(
		target = TDTPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = TDTPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
