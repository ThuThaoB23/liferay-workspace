...
public interface EmployeeLocalService
	...
	public Employee createEmployee(int empId);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Employee deleteEmployee(int empId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Employee getEmployee(int empId) throws PortalException;
